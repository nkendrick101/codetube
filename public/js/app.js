...
var VueSelectize = __webpack_require__(4);

Vue.component('video-player', __webpack_require__(15));
Vue.component('video-upload', __webpack_require__(24));
Vue.component('subscribe-button', __webpack_require__(32));
Vue.component('video-voting', __webpack_require__(35));
Vue.component('video-comments', __webpack_require__(38));
Vue.component('image-upload', __webpack_require__(43));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_plyr__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_plyr_dist_vue_plyr_css__ = __webpack_require__(21);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Plyr; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_plyr_dist_plyr_css__ = __webpack_require__(18);
...
var Plyr = { render: function () {
  ...
  mounted: function mounted() {
    ...
    var plyr = __webpack_require__(1);
...
var render = function() {
  ...
  return _c("plyr", { ref: "player" }, [
    _c("video", [
      _c("source", { attrs: { src: _vm.videoUrl, type: "video/webm" } })
    ])
  ])
}
var staticRenderFns = []
...
Component.options.__file = "resources/assets/js/components/VideoUpload.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-713d2816", Component.options)
  } else {
    hotAPI.reload("data-v-713d2816", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("608b9b6d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-713d2816\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VideoUpload.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-713d2816\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./VideoUpload.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_selectize__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue2_dropzone__ = __webpack_require__(30);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fileAddedEvent: function fileAddedEvent(file) {
            var _this = this;

            this.store(file).then(function () {
                _this.$refs.dropzoneVideo.processQueue();
                _this.uploading = true;
                _this.failed = false;
            });
        },
        sendingEvent: function sendingEvent(file, xhr, form) {
        ...
        uploadCompleteEvent: function uploadCompleteEvent(file, response) {
        ...
        errorEvent: function errorEvent(file, message, xhr) {
            ...
            this.failed = true;
            this.error = message;
            this.$http.delete('/videos/' + this.uuid, { body: { _token: this.token } });
        },
        store: function store(file) {
            var _this2 = this;
            ...
            return this.$http.post('/videos', {
                ...
                _this2.uuid = response.data.uuid;
            });
        },
        update: function update() {
            ...
            return this.$http.put('/videos/' + this.uuid, {
                title: this.title,
                description: this.description,
                visibility: this.visibility,
                _token: this.token
            }).then(function (response) {
                _this3.status = 'Changes saved';

                setTimeout(function () {
                    return _this3.status = null;
                }, 3000);
            }).catch(function () {
                _this3.status = 'Failed to save changes';
            });
        }
    }
});
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "modal fade", attrs: { id: "upload-video-modal" } },
    [
      _c(
        "div",
        ...
        [
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "m-portlet m-portlet--full-height" }, [
                ...
                [
                  _c("vue-dropzone", {
                    ...
                    on: {
                      ...
                      "vdropzone-file-added": _vm.fileAddedEvent,
                      "vdropzone-success": _vm.uploadCompleteEvent,
                      "vdropzone-upload-progress": _vm.updateProgressEvent
                    }
                  })
                ],
                1
              ...
              _vm._v(" "),
              _c("div", { staticClass: "m-portlet__foot" }, [
                _vm.uploading && !_vm.failed
                  ? _c("div", [
                      _c("div", { staticClass: "m-portlet__body" }, [
                        _c("div", { staticClass: "row" }, [
                          _c("div", {
                            staticClass: "col-form-label col-lg-2 col-sm-12"
                          }),
                          _vm._v(" "),
                          _c(
                            "div",
                            ...
                            [
                              !_vm.uploadingComplete
                                ? _c(
                                    ...
                                    {
                                      staticClass:
                                        "alert alert-info m-alert m-alert--outline"
                                    },
                                    [
                                      _vm._v(
                                      ...
                                      _c(
                                        "a",
                                        {
                                          staticClass: "m=link m--link-info",
                                          attrs: {
                                            href:
                                              _vm.$root.url +
                                              "/videos/" +
                            ...
                            [
                              _vm.uploadingComplete
                                ? _c(
                                    ...
                                    {
                                      staticClass:
                                        "alert alert-success m-alert m-alert--outline"
                                    },
                                    [
                                      _vm._v(
                                      ...
                                      _c(
                                        "a",
                                        {
                                          staticClass: "m-link m-link--success",
                                          attrs: {
                                            href: _vm.$root.url + "/videos"
                                          }
                                        },
                                        [_c("strong", [_vm._v("videos")])]
                                      ),
                                      _vm._v(
                                        ".\n                                        "
                                      )
                            ...
                            _c(
                              ...
                              [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "btn btn-sm btn-focus m-btn m-btn--custom m-btn--wide m-btn--icon m-btn--air",
                                    attrs: { type: "submit" },
                                    on: {
  ...
  function() {
    ...
    return _c(
      "div",
      {
        ...
        staticStyle: { padding: "0 20px 0 20px", height: "4.0rem" }
      },
      [
        ...
        _c("div", { staticClass: "m-portlet__head-tools" }, [
          _c("ul", { staticClass: "m-portlet__nav" }, [
            _c(
              "li",
              { staticClass: "m-portlet__nav-item m-portlet__nav-item--last" },
              [
                _c(
                  "a",
                  {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-713d2816", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d2552396", Component.options)
  } else {
    hotAPI.reload("data-v-d2552396", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getSubscriptionStatus: function getSubscriptionStatus() {
            var _this = this;

            this.$http.get('/subscriptions/' + this.channelSlug).then(function (response) {
                _this.subscribers = response.body.count;
                _this.userSubscribed = response.body.user_subscribed;
                _this.canSubscribe = response.body.can_subscribe;
            });
        },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.canSubscribe && _vm.subscribers !== null
    ? _c("span", [
        _c(
          "button",
          {
            class: _vm.userSubscribed
              ? "btn btn-secondary m-btn m-btn--wide"
              : "btn btn-danger m-btn m-btn--wide",
            on: {
              click: function($event) {
                $event.preventDefault()
                _vm.handle()
    ...
    : !_vm.canSubscribe && _vm.subscribers !== null
      ? _c("span", [
          _c(
            "button",
            { staticClass: "btn btn-danger m-btn m-btn--wide disabled" },
            [
              _vm._v(
                "\n        \tSubscribers   " +
                  _vm._s(_vm.subscribers) +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-d2552396", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/VideoVoting.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f63b81b", Component.options)
  } else {
    hotAPI.reload("data-v-3f63b81b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getVotes: function getVotes() {
            ...
            this.$http.get('/videos/' + this.videoUuid + '/votes').then(function (response) {
                _this.up = response.body.up;
                _this.down = response.body.down;
                _this.canVote = response.body.can_vote;
                _this.userVote = response.body.user_vote;
            });
        },
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("span", { staticClass: "video__votes" }, [
    _c(
      "a",
      {
        class:
          _vm.userVote == "up"
            ? "btn btn-primary m-btn m-btn--icon"
            : "btn btn-secondary m-btn m-btn--icon",
        attrs: { href: "#" },
        on: {
          click: function($event) {
            $event.preventDefault()
      ...
      [
        _c("span", [
          _c("i", { staticClass: "la la-thumbs-up" }),
          _vm._v(" "),
          _c("span", [_vm._v("\n\t\t\t\t" + _vm._s(_vm.up) + "\n\t\t\t")])
        ])
      ]
    ...
    _vm._v(" "),
    _c("span", { staticClass: "m--margin-right-5" }),
    _vm._v(" "),
    _c(
      "a",
      {
        class:
          _vm.userVote == "down"
            ? "btn btn-danger m-btn m-btn--icon"
            : "btn btn-secondary m-btn m-btn--icon",
        attrs: { href: "#" },
        on: {
          click: function($event) {
      ...
      [
        _c("span", [
          _c("i", { staticClass: "la la-thumbs-down" }),
          _vm._v(" "),
          _c("span", [_vm._v("\n\t\t\t\t" + _vm._s(_vm.down) + "\n\t\t\t")])
        ])
      ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3f63b81b", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48c08368", Component.options)
  } else {
    hotAPI.reload("data-v-48c08368", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getComments: function getComments() {
            ...
            this.$http.get('/videos/' + this.videoUuid + '/comments').then(function (response) {
            ...
            this.$http.post('/videos/' + this.videoUuid + '/comment', {
                ...
                _this3.comments.map(function (comment, index) {
                    if (comment.id === commentId) {
                        _this3.comments[index].replies.data.push(response.body.data);
                    }
                });
        ...
        showConfirmationDialogue: function showConfirmationDialogue(isComment) {
            if (isComment) {
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "m-portlet m-portlet--bordered m-portlet--rounded m-portlet--unair m--margin-top-35"
    },
    [
            ...
            _c("div", { staticClass: "m-portlet__head-title" }, [
              _c(
                ...
                [
                  _vm._v(
                    "\n                        " +
                      _vm._s(_vm.pluralize(_vm.comments.length, "comment")) +
                      "\n                    "
                  )
                ]
              )
        ...
        ? _c("div", { staticClass: "m-portlet__body" }, [
            _c("div", { staticClass: "media" }, [
              _c("div", { staticClass: "media-left" }, [
                _c("a", { attrs: { href: "#" } }, [
                  _c("img", {
                    staticClass: "d-flex mr-3 channel-img img-circle",
              ...
              _c("div", { staticClass: "media-body" }, [
                _c("textarea", {
                  ...
                  attrs: { placeholder: "Add a public comment ...", rows: "4" },
                ...
                _vm._v(" "),
                _c("div", { staticClass: "float-right m--margin-top-10" }, [
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-sm btn-metal m-btn m-btn--wide",
                      attrs: { type: "submit" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
        ...
        : _c(
            "div",
            {
              ...
              staticStyle: {
                ...
                "box-shadow":
                  "0 1px 0 rgba(0,0,0,0.05) inset, 0 2px 0 rgba(0,0,0,0.1)",
                padding: "0px"
              }
            },
            [_vm._m(0)]
                    ...
                    [
                      _c("div", { staticClass: "m-widget3__header" }, [
                        _c("div", { staticClass: "m-widget3__user-img" }, [
                          _c("img", {
                            ...
                            staticStyle: { width: "50px", height: "auto" },
                            attrs: { src: comment.channel.data.image }
                          })
                        ]),
                        _vm._v(" "),
                        _c("div", { staticClass: "m-widget3__info" }, [
                          _c("span", { staticClass: "m-widget3__username" }, [
                            _vm._v(
                              "\n                            " +
                                _vm._s(comment.channel.data.name) +
                                "\n                        "
                            )
                          ]),
                          _vm._v(" "),
                          _c("br"),
                          _vm._v(" "),
                          _c("span", { staticClass: "m-widget3__time" }, [
                            _vm._v(
                              "\n                            " +
                        ...
                        _vm._v(" "),
                        _vm.$root.user.authenticated
                          ? _c("span", { staticClass: "m-widget3__status" }, [
                              _c(
                                "a",
                                {
                      ...
                      _vm.replyFormVisible === comment.id
                        ? _c(
                            ...
                            {
                              staticClass:
                                "media m--margin-top-35 m--margin-left-50"
                            },
                            [
                              _c("div", { staticClass: "media-left" }, [
                                _c("a", { attrs: { href: "#" } }, [
                                  _c("img", {
                                    staticClass:
                                      "d-flex mr-3 channel-img img-circle",
                                    staticStyle: {
                                      width: "50px",
                                      height: "auto"
                                    },
                              ...
                              _c("div", { staticClass: "media-body" }, [
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "float-right m--margin-top-10 m--margin-bottom-10"
                                  },
                                  [
                                    _c(
                                      "button",
                                      {
                                        staticClass:
                                          "btn btn-sm btn-metal m-btn m-btn--wide",
                                        attrs: { type: "submit" },
                                        on: {
                                          click: function($event) {
                                            $event.preventDefault()
                      ...
                      _vm._l(comment.replies.data, function(reply) {
                        return _c(
                          "div",
                          { staticClass: "m-widget3__item m--margin-left-50" },
                          [
                            _c("div", { staticClass: "m-widget3__header" }, [
                              _c(
                                "div",
                                { staticClass: "m-widget3__user-img" },
                                [
                                  _c("img", {
                                    staticClass: "m-widget3__img",
                                    staticStyle: {
                              ...
                              _c("div", { staticClass: "m-widget3__info" }, [
                                _c(
                                  "span",
                                  { staticClass: "m-widget3__username" },
                                  [
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(reply.channel.data.name) +
                                        "\n                            "
                                    )
                                  ]
                                ),
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      {
        staticClass: "alert m-alert--default m-alert--icon",
        staticStyle: { "margin-bottom": "0", "background-color": "#f9fafa" }
      },
      [
        _c("div", { staticClass: "m-alert__icon" }, [
          _c("i", { staticClass: "flaticon-exclamation-2" })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "m-alert__text" }, [
          ...
          _c(
            "a",
            {
              staticClass: "m-link m-link--secondary",
              attrs: { href: "/login" }
            },
            [_vm._v("sign in")]
          ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48c08368", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "modal fade", attrs: { id: "upload-image-modal" } },
    [
      _c(
        "div",
        { staticClass: "modal-dialog modal-lg modal-dialog-centered" },
                ...
                [
                  _c("vue-dropzone", {
                    ...
                    on: {
                      "vdropzone-error": _vm.errorEvent,
                      "vdropzone-sending": _vm.sendingEvent,
                      "vdropzone-success": _vm.uploadSuccessEvent,
                      "vdropzone-upload-progress": _vm.updateProgressEvent
                    }
                  })
                ],
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(27)("012c4255", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
