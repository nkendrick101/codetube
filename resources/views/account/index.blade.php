            ...
            <div class="m-portlet__head-tools">
              <ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--left m-tabs-line--focus">
                <li class="nav-item m-tabs__item">
                  <a href="{{ route('account', ['username' => $user->channel()->first()->slug, 'section' => 'profile']) }}" 
                ...
                <li class="nav-item m-tabs__item">
                  <a href="{{ route('account', ['username' => $user->channel()->first()->slug, 'section' => 'channel']) }}" 
                    class="nav-link m-tabs__link {{ $section === 'channel' ? 'active' : '' }}">
                ...
                <li class="nav-item m-tabs__item">
                  <a href="{{ route('account', ['username' => $user->channel()->first()->slug, 'section' => 'payment']) }}" 
