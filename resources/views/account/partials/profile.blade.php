		...
		<div class="form-group m-form__group row m--margin-top-25 {{ $errors->has('name') ? 'has-danger' : '' }}">
			...
			<div class="col-lg-10 col-md-12 col-sm-12">
				<div class="m-input-icon m-input-icon--left">
					<input class="form-control m-input {{ $errors->has('name') ? 'form-control-danger' : '' }}" type="text" name="name" placeholder="Full name" value="{{ old('name', $user->name) }}">
		...
		<div class="form-group m-form__group row {{ $errors->has('facebook_id') ? 'has-danger' : '' }}">
			...
			<div class="col-lg-10 col-md-12 col-sm-12">
				<div class="input-group m-input-group">
					...
					<input class="form-control m-input {{ $errors->has('facebook_id') ? 'form-control-danger' : '' }}" type="text" name="facebook_id" placeholder="Facebook" value="{{ old('facebook_id', $user->facebook_id) }}">
				</div>
