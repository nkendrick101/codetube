...
@section('content')
   <div class="container m--margin-top-35 m--margin-bottom-45">
      <div class="row">
      		@foreach ($videos as $video)
	     		<div class="col-lg-4 m--margin-bottom-35">
	     			<div class="m-portlet m-portlet--bordered m-portlet--rounded m-portlet--unair video-container" data-aos="fade-down">
