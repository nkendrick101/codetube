...
--
-- Host: localhost    Database: codetube
-- ------------------------------------------------------
...
CREATE TABLE `channels` (
  ...
  `image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'https://storage.googleapis.com/images_codetube/user.png',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `video_views` (
  ...
  KEY `video_views_video_id_foreign` (`video_id`),
...
CREATE TABLE `videos` (
  ...
  CONSTRAINT `videos_channel_id_foreign` FOREIGN KEY (`channel_id`) REFERENCES `channels` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-05 20:25:50
