...
class EmailVerification extends Notification
{
  ...
  public function toMail($notifiable) {
    return (new MailMessage)
      ...
      ->line('If you did not register for an account, or no longer wish to activate it, take no action. Simply delete this message and that will be the end of it. Also, in case you have any questions, feel free to reach out to us.');
  }
